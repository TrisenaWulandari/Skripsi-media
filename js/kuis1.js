...
// // -----------------------------------------------------------------------------------------
// // mengambil data dan menampilkanya json
...
//         createTask(nama, nisn, sekolah, hasilakhir, waktunya, harinya, new_jwb_urut);
...
//   }
// };
// dat.open("GET", "json/kuis1.json", true);
// dat.send();
...
// function createTask(nama, nisn, sekolah, nilai, waktunya, hari, jwb) {
//   counter += 1;
//   set(ref(db, "kuis1/" + counter), {
//     id: counter,
//     nama: nama,
...
// };
// //pemanggilan soal json
// dat.open("GET", "/json/kuis.json", true);
// dat.send();
